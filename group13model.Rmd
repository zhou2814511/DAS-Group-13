...
```{r glm stepwise plot,eval=TRUE, warning=FALSE, message=FALSE,out.width = '100%', fig.align = "center", ,fig.pos = "h",fig.cap="\\label{fig:glm stepwise plot} Odds of various factors influencing the quality of coffee(GLM stepwise regression)"}
